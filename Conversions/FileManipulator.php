...
use Modules\Media\Conversions\Actions\PerformConversionAction;
use Modules\Media\Conversions\ImageGenerators\ImageGeneratorFactory;
use Modules\Media\Conversions\Jobs\PerformConversionsJob;
...
class FileManipulator
{
    ...
    protected function dispatchQueuedConversions(
        ...
        $performConversionsJobClass = config(
            'media.jobs.perform_conversions',
    ...
    protected function generateResponsiveImages(Media $media, bool $withResponsiveImages)
    {
        ...
        $generateResponsiveImagesJobClass = config(
            'media.jobs.generate_responsive_images',

...
use Omaicode\Image\Manipulations;
use Modules\Media\MediaCollections\Exceptions\InvalidConversion;
...
class ConversionCollection extends Collection
{
    ...
    protected function addConversionsFromRelatedModel(Media $media): void
    {
        ...
        /** @var \Modules\Media\Interfaces\HasMedia $model */
        $model = new $modelName();
    ...
    {
        /** @var \Modules\Media\Conversions\Conversion|null $conversion */

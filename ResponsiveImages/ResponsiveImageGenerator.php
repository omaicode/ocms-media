...
namespace Modules\Media\ResponsiveImages;
...
use Modules\Media\ResponsiveImages\Events\ResponsiveImagesGenerated;
use Modules\Media\ResponsiveImages\Exceptions\InvalidTinyJpg;
...
use Modules\Media\Support\FileNamer\FileNamer;
use Modules\Media\Support\ImageFactory;
use Modules\Media\Support\TemporaryDirectory;
use Omaicode\TemporaryDirectory\TemporaryDirectory as BaseTemporaryDirectory;
...
class ResponsiveImageGenerator
{
    ...
    public function __construct(
        ...
        $this->fileNamer = app(config('media.file_namer'));
    }
    ...
    public function generateTinyJpg(
        ...
        $svg = view('media::placeholderSvg', compact(
            'originalImageWidth',
            'originalImageHeight',
            'tinyImageBase64'
        ));

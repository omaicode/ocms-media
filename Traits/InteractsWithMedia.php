...
use Modules\Media\Downloaders\DefaultDownloader;
use Modules\Media\Interfaces\HasMedia;
use Modules\Media\MediaCollections\Events\CollectionHasBeenCleared;
use Modules\Media\MediaCollections\Exceptions\InvalidBase64Data;
use Modules\Media\MediaCollections\Exceptions\InvalidUrl;
use Modules\Media\MediaCollections\Exceptions\MediaCannotBeDeleted;
use Modules\Media\MediaCollections\Exceptions\MediaCannotBeUpdated;
use Modules\Media\MediaCollections\Exceptions\MimeTypeNotAllowed;
use Modules\Media\MediaCollections\FileAdder;
use Modules\Media\MediaCollections\FileAdderFactory;
...
use Modules\Media\Support\MediaLibraryPro;
use Modules\MediaPro\PendingMediaLibraryRequestHandler;

trait InteractsWithMedia
{
    /** @var \Modules\Media\Conversions\Conversion[] */
    public array $mediaConversions = [];

    /** @var \Modules\Media\MediaCollections\MediaCollection[] */
    ...
    {
        return $this->morphMany(config('media.media_model'), 'model');
    }
     ...
     * @return \Modules\Media\MediaCollections\FileAdder
     *
     * @throws \Modules\Media\MediaCollections\Exceptions\FileCannotBeAdded
     */
    public function addMediaFromUrl(string $url, ...$allowedMimeTypes): FileAdder
    {
        ...
        $downloader = config('media.media_downloader', DefaultDownloader::class);
     ...
     *
     * @return \Modules\Media\MediaCollections\Models\Collections\MediaCollection
     */
    public function getMedia(string $collectionName = 'default', $filters = []): \Modules\Media\MediaCollections\Models\Collections\MediaCollection
    {
     ...
     *
     * @param string $collectionName
     * @param \Modules\Media\MediaCollections\Models\Media[]|\Illuminate\Support\Collection $excludedMedia
     *
     * @return $this
     */
     ...
     *
     * @param int|\Modules\Media\MediaCollections\Models\Media $mediaId
     *
     * @throws \Modules\Media\MediaCollections\Exceptions\MediaCannotBeDeleted
     */
    ...
    public function loadMedia(string $collectionName): Collection
    {
        ...
        $collection = new \Modules\Media\MediaCollections\Models\Collections\MediaCollection($collection);
     ...
     */
    public function allMedia($collection = 'default'): Collection
    {
        return $this->getMediaRepository()->getByModelTypeAndCollectionName(self::class, $collection);
    }
}

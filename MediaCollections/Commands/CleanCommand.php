...
namespace Modules\Media\MediaCollections\Commands;
...
class CleanCommand extends Command
{
    ...
    protected $signature = 'media:clean {modelType?} {collectionName?} {disk?}
    ...
    {
        $diskName = $this->argument('disk') ?: config('media.disk_name');
